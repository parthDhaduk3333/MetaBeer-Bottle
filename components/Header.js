                ...
                <div className="d-flex justify-content-start align-items-center my-5">
                    ...
                    <nav className="ms-auto">
                        <ul className="navbar">
                            ...
                            <li className="nav wow fadeIn" data-wow-delay="1.5s"><a href="https://bottleverse.metabeerbottle.com" className="navItem NavTxt f-16" target="_blank" rel="noreferrer">BOTTLEVERSE</a></li>
                        </ul>
                    </nav>
